...
impl CreatorInfo {
    pub async fn fetch_creator_data(profile_id: &str, language: Language) -> Result<Self, String> {
...
#[tauri::command]
pub async fn get_author_info(profile_id: &str, language: Language) -> Result<CreatorInfo, String> {
